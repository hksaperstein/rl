...
parser.add_argument(
    "--variant",
    choices=["joint-die", "joint-cube", "joint-die-heavy", "joint-die-big", "joint-cube-baked", "joint-die-mixed"],
    required=True,
)
...
def main() -> None:
    if args_cli.variant == "joint-die":
        ...
        from tasks.franka.dice_lift_joint_env_cfg import FrankaDieLiftJointBigEnvCfg as Cfg
    elif args_cli.variant == "joint-cube-baked":
        from tasks.franka.dice_lift_joint_env_cfg import FrankaCubeBakedLiftJointEnvCfg as Cfg
    elif args_cli.variant == "joint-die-mixed":
        from tasks.franka.dice_lift_joint_env_cfg import FrankaDieLiftJointMixedEnvCfg as Cfg
    else:
