...
def _grasp_lift_state(
    ...
    cube_height_above_ground = object.data.root_pos_w[:, 2] - 0.0075  # cube half-size, resting height (15mm cube as of 2026-07-24)
...
def grasp_goal_milestone_bonus(
    ...
    cube_height_above_ground = object.data.root_pos_w[:, 2] - 0.0075  # 15mm cube as of 2026-07-24
